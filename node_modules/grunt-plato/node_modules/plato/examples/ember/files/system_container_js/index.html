...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="span12">Ember.Container = requireModule('container');
Ember.Container.set = Ember.set;</textarea>
  </div>
</div>
